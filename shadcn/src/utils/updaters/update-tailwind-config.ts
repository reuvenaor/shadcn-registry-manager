...
import { updateTailwindConfigOptionsSchema } from "@/src/schemas/update.schemas"
...
export async function updateTailwindConfig(
  tailwindConfig:
    ...
    | undefined,
  config: Config,
  options: z.infer<typeof updateTailwindConfigOptionsSchema>,
  ...
  const validatedOptions = updateTailwindConfigOptionsSchema.parse(options)
  ...
  const tailwindSpinner = spinner(
    `Updating ${tailwindFileRelativePath}`,
    extra,
    "tailwind-config"
  ).start()
