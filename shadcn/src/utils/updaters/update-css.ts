...
import { updateCssOptionsSchema } from "@/src/schemas/update.schemas"
...
export async function updateCss(
  ...
  config: Config,
  options: z.infer<typeof updateCssOptionsSchema>,
  ...
  const validatedOptions = updateCssOptionsSchema.parse(options)
