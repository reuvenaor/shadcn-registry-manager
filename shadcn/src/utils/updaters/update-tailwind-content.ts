...
import { updateTailwindContentOptionsSchema } from "@/src/schemas/update.schemas"
...
export async function updateTailwindContent(
  content: string[],
  config: Config,
  options: z.infer<typeof updateTailwindContentOptionsSchema>,
  ...
  const validatedOptions = updateTailwindContentOptionsSchema.parse(options)
